...
| `unslop` | Cut AI tells from any writing. Removes puffery, AI vocabulary, em dashes, inline-header lists and filler, then adds human voice. Use when writing or editing any prose: docs, READMEs, commit messages, PR descriptions, chat replies. |
